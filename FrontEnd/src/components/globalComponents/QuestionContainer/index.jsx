...
const QuestionContainer = ({ question, answer }) => {
    ...
    return (
        <>
            <div className={`${isExpand ? 'py-5 sm:py-0' : ''} w-full bg-gray-200 hover:bg-gray-300 transition-all duration-300 px-5 rounded-3xl overflow-hidden active:bg-gray-300`}>
