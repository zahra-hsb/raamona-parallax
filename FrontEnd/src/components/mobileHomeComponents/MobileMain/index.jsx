...
import initialBg from '../../../../public/images/mobileParallax/Home-Mobile.png'
            ...
            <section ref={parallaxRef} className="w-full relative bg-gradient-to-b from-[#474afe] to-[#a4f1de] overflow-hidden h-screen">
                ...
                <div className={`w-full ${isLoad ? 'flex' : 'hidden'} relative`}>
                    ...
                    <Button
                        ...
                        style={'absolute z-50 top-[500px] mt-1 mr-1 right-[30%] !py-1 !px-2'}
                    />
                </div>
                <div>
                    {/* scroll */}
                    ...
                    <Image className={`${!isLoad ? ` opacity-100 z-50` : 'opacity-0 -z-50'} transition-all duration-500 fixed top-0 right-0 w-full h-screen`} src={initialBg} alt="" />
