            ...
            <div className="flex justify-center items-center px-20 py-5">
                ...
                <span className={` ${currentPage === 1 ? `-translate-x-10` : ``} transition-all duration-300`}>
                    ...
                    <button  
                        ...
                        className={`border rounded ${currentPage !== index + 1 ? 'rounded-full px-3 py-1 border-2 ' : 'border-gray-400 rounded-full px-4 border-2 py-2'} transition-all duration-300 m-1 ${currentPage > 2 }`}>  
                        {index + 1}  
                    </button>  
                ))}  
                </span>
